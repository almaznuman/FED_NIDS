...
def get_evaluate_fn():
    ...
    def evaluate(
        ...
        accuracy = accuracy_score(y_true_numpy, y_pred_binary)
        precision = precision_score(y_true_numpy, y_pred_binary)
        recall = recall_score(y_true_numpy, y_pred_binary)
        f1 = f1_score(y_true_numpy, y_pred_binary)
...
# Create ServerApp with diversity-aware strategy
